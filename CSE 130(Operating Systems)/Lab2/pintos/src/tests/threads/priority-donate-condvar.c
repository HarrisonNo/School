...
//Low acquires threadlock (pri +1)
//Low waits on condvar (pri +1)
//Med waits on condvar (pri +3)
//High waits on threadlock (pri +5)
//High boosts Lows priority to +5
//Main condsignals, releasing Low
//Low waits on condvarlock
//Low boosts Main priority to +5
//Main releases condvarlock
//Main goes back to 0 priority
//Main yields to Low
