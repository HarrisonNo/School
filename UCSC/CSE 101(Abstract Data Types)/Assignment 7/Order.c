 ...
 * Order.c
 * Client file for the C Red Black Dictionary ADT
 * ***********************************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int NumOfArgs, char* ArgNames[])
{
    ...
    int tempnum=1, *temparray=&tempnum;
    for(int i=0;i<NumberOfLines;i++)
    {
        insert(D,InputStringsArray[i],temparray);
    }
    //Printing to output
    fprintf(outputfile,"******************************************************\n");
    fprintf(outputfile,"PRE-ORDER:\n");
    fprintf(outputfile,"******************************************************\n");
    printDictionary(outputfile,D,"pre");
    fprintf(outputfile,"******************************************************\n");
    fprintf(outputfile,"IN-ORDER:\n");
    fprintf(outputfile,"******************************************************\n");
    printDictionary(outputfile,D,"in");
    fprintf(outputfile,"******************************************************\n");
    fprintf(outputfile,"POST-ORDER:\n");
    fprintf(outputfile,"******************************************************\n");
    printDictionary(outputfile,D,"post");
